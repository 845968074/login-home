...
function get_Pending_user(callback) {
     ...
     let user = data;
     console.log("manager/users/all: "+user);
...
function set_Tbody(user_data) {
    ...
    _.map(user_data.data, function ({balance, deposit, reg_time, review_prog,
        ...
        console.log("manager/users/all set_Tbody： "+user_id+permissions);
...
function show_Review() {
    get_Pending_user(function (user_data) {
        console.log("manager/users/all  get_Pending_user: "+user_data.data);
